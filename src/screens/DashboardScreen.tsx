        ...
        {/* SELECIONE O GRUPO PRIORITÁRIO */}
          {(() => {
            const PRIORITY_GROUPS = [
              { num: '1º', titulo: 'Mulheres de 30 a 49 anos', desc: 'em atraso no rastreamento com exame citopatológico (mais de 3 anos sem rastreio) e, também, ainda não realizaram o teste de DNA-HPV', pattern: /30.*49/i, color: 'purple', gradient: 'from-purple-600 to-purple-400', bg: 'bg-purple-50', border: 'border-purple-200', text: 'text-purple-700', ring: 'ring-purple-400/30', glow: 'shadow-purple-500/25', hoverGlow: 'hover:shadow-purple-500/40', hoverBorder: 'hover:border-purple-400', numBg: 'bg-purple-600', numText: 'text-white', iconColor: 'text-purple-500' },
              { num: '2º', titulo: 'Mulheres de 50 a 64 anos', desc: 'em atraso no rastreamento com exame citopatológico (mais de 3 anos sem rastreio) e, também, ainda não realizaram o teste de DNA-HPV', pattern: /50.*6[0-4]|6[0-4].*50|50.*65(?![0-9])|50.*65$/i, color: 'fuchsia', gradient: 'from-fuchsia-600 to-fuchsia-400', bg: 'bg-fuchsia-50', border: 'border-fuchsia-200', text: 'text-fuchsia-700', ring: 'ring-fuchsia-400/30', glow: 'shadow-fuchsia-500/25', hoverGlow: 'hover:shadow-fuchsia-500/40', hoverBorder: 'hover:border-fuchsia-400', numBg: 'bg-fuchsia-600', numText: 'text-white', iconColor: 'text-fuchsia-500' },
              { num: '3º', titulo: 'Mulheres de 30 a 49 anos', desc: 'independente da história anterior de rastreamento com o exame citopatológico e, também, ainda não realizaram o teste de DNA-HPV', pattern: /30.*49/i, color: 'violet', gradient: 'from-violet-600 to-violet-400', bg: 'bg-violet-50', border: 'border-violet-200', text: 'text-violet-700', ring: 'ring-violet-400/30', glow: 'shadow-violet-500/25', hoverGlow: 'hover:shadow-violet-500/40', hoverBorder: 'hover:border-violet-400', numBg: 'bg-violet-600', numText: 'text-white', iconColor: 'text-violet-500' },
