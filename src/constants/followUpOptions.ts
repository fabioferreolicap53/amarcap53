...
export const SITUACAO_POS_BUSCA_OPTIONS: SelectOption[] = [
  ...
  },
  {
    ...
    aliases: ["3 - CITOPATOLÓGICO REALIZADO NOS ÚLTIMOS 3 ANOS EM OUTRA UNIDADE DO SUS COM FORNECIMENTO DO LAUDO E RESULTADO REGISTRADO NO PEP", "3 - CITOPATOLÓGICO REALIZADO NOS ÚLTIMOS 3 ANOS, EM OUTRA UNIDADE DO SUS COM FORNECIMENTO DO LAUDO E RESULTADO REGISTRADO NO PEP", "3 - Citopatológico realizado nos últimos 3 anos em outra unidade do SUS com fornecimento do laudo e resultado registrado no PEP"]
  },
  {
    ...
    aliases: ["4 - CITOPATOLÓGICO REALIZADO NOS ÚLTIMOS 3 ANOS EM OUTRA UNIDADE DA REDE PRIVADA COM FORNECIMENTO DO LAUDO E RESULTADO REGISTRADO NO PEP", "4 - CITOPATOLÓGICO REALIZADO NOS ÚLTIMOS 3 ANOS, EM OUTRA UNIDADE DA REDE PRIVADA COM FORNECIMENTO DO LAUDO E RESULTADO REGISTRADO NO PEP", "4 - Citopatológico realizado nos últimos 3 anos em outra unidade da rede privada com fornecimento do laudo e resultado registrado no PEP"]
  },
  {
    ...
    aliases: ["5 - TESTE MOLECULAR/DNA-HPV ONCOGÊNICO REALIZADO NOS ÚLTIMOS 5 ANOS EM OUTRA UNIDADE DO SUS COM RESULTADO REGISTRADO NO PEP", "5 - TESTE MOLECULAR/ DNA-HPV ONCOGÊNICO REALIZADO NOS ÚLTIMOS 5 ANOS, EM OUTRA UNIDADE DO SUS COM RESULTADO REGISTRADO NO PEP", "5 - Teste molecular/DNA-HPV oncogênico realizado nos últimos 5 anos em outra unidade do SUS com resultado registrado no PEP"]
  },
  {
    ...
    aliases: ["6 - TESTE MOLECULAR/DNA-HPV ONCOGÊNICO REALIZADO NOS ÚLTIMOS 5 ANOS EM OUTRA UNIDADE DA REDE PRIVADA COM RESULTADO REGISTRADO NO PEP", "6 - TESTE MOLECULAR/ DNA-HPV ONCOGÊNICO REALIZADO NOS ÚLTIMOS 5 ANOS, EM OUTRA UNIDADE DA REDE PRIVADA COM RESULTADO REGISTRADO NO PEP", "6 - Teste molecular/DNA-HPV oncogênico realizado nos últimos 5 anos em outra unidade da rede privada com resultado registrado no PEP"]
  },
  {
...
export const ENTRAVES_IDENTIFICADOS_OPTIONS: SelectOption[] = [
  ...
  {
    label: "DIFICULDADE DE LOCOMOÇÃO POR EXEMPLO ACAMADA",
    value: "DIFICULDADE DE LOCOMOÇÃO POR EXEMPLO ACAMADA",
    aliases: ["5 - DIFICULDADE DE LOCOMOÇÃO POR EXEMPLO ACAMADA", "5 - DIFICULDADE DE LOCOMOÇÃO (EX:ACAMADA)", "5 - DIFICULDADE DE LOCOMOÇÃO ( EX: ACAMADA)", "5 - Dificuldade de locomoção por exemplo acamada", "5 - Dificuldade de locomoção ( ex: acamada)"]
  },
  {
