...
export const TIPO_CONTATO_OPTIONS: SelectOption[] = [
  ...
  },
  {
    ...
    aliases: ["3 - NÃO HOUVE CONTATO ( NÃO LOCALIZADA, LIGAÇÃO NÃO ATENDIDA...)", "NÃO HOUVE CONTATO (NÃO LOCALIZADA, LIGAÇÃO NÃO ATENDIDA...)", "NÃO HOUVE CONTATO (NÃO LOCALIZADA, LIGAÇÃO NÃO ATENDIDA…)"]
  }
];
